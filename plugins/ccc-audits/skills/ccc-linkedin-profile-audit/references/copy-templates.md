# LinkedIn Profile Audit — Phase 5 Copy Templates

*Last updated: 2026-03. Review if CCC positioning docs (voice.md, context.md, ICP.md) change.*
...
Apply voice.md rules strictly. **Never use in any generated copy:**
